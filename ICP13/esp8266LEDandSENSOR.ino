...
#include <DHT.h>
const char* ssid = "Alders";  // Enter SSID here
const char* password = "Seats123";  //Enter Password here
...
DHT dht(sensor, DHTTYPE); //// Initialize DHT sensor for normal 16mhz Arduino
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /sensor/mobile") >= 0) {
              ...
              client.println("<p><a href=\"/sensor\"><button class=\"button button3\">GET DATA</button></a></p>");
              client.println("<p>");
              client.println(sensorData);
              client.println("</p>");
